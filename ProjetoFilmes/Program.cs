...
namespace FilmesProjeto
{
    class Program
    {
        ...
        private static void VisualizarFilme()
        {
            ...
            int indiceFilme = int.Parse(Console.ReadLine());
            {
                System.Console.WriteLine("{0}-{1}", indiceFilme, Enum.GetName(typeof(Genero), indiceFilme));
            }
        ...
        {
            Console.WriteLine();
            Console.WriteLine("Bem vindo(a) ao nosso acervo de filmes!");
